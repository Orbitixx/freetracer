...
pub const Color = struct {
    ...
    pub const violet = rl.Color{ .r = 248, .g = 135, .b = 255, .a = 63 };
    // pub const violet = rl.Color{ .r = 248, .g = 135, .b = 255, .a = 43 };
    pub const darkViolet = rl.Color{ .r = 248, .g = 135, .b = 255, .a = 60 };
    // pub const darkViolet = rl.Color{ .r = 248, .g = 135, .b = 255, .a = 20 };
    pub const blueGray = rl.Color{ .r = 49, .g = 85, .b = 100, .a = 150 };
    // pub const blueGray = rl.Color{ .r = 49, .g = 85, .b = 100, .a = 255 };
    pub const darkBlueGray = rl.Color{ .r = 49, .g = 65, .b = 84, .a = 150 };
    ...
    pub const darkGreen = rl.Color{ .r = 40, .g = 60, .b = 67, .a = 100 };
